...
cityname_app = Blueprint('cityname_app', __name__)
...
def get_all_districts() :
    try :
        ...
        cursor.execute("SELECT DISTINCT cityName FROM attractions")
...
@cityname_app.route('/cityname')
def cityname() :
    # 获取所有的 districtName 用于下拉框选择
    districts = get_all_districts()
    return render_template('cityname.html' , districts=districts)


@cityname_app.route('/get_data/cityname' , methods=[ 'GET' ])
def get_data() :
    # 获取前端传来的选择地区
